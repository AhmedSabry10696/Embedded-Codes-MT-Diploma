...
void LCD_goToRowColumn(uint8 row,uint8 col)
{
	...
	switch(row)
	{
		case 0:
				...
				break;
		case 1:
				Address=col+0x40; /*0x40 begining address for 2nd row*/
				break;
		case 2:
				Address=col+0x10; /*0x10 begining address for 3rd row*/
				break;
		case 3:
				Address=col+0x50; /*0x50 begining address for 4th row*/
				break;
	}					
