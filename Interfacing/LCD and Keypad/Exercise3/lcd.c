...
void LCD_displayCharacter(uint8 data)
{
	...
	_delay_ms(1); /* delay for processing Tpw - Tdws = 190 ns */
	#if (DATA_BITS_MODE == 4)
		/* out the highest 4 bits of the required char to the data bus D4 --> D7 */
		#ifdef UPPER_PORT_PINS
...
void LCD_goToRowColumn(uint8 row,uint8 col)
{
	...
	{
		case 0:
				Address=col;	/* 0x00 begining address for the 1st row*/
				break;
		case 1:
				Address=col+0x40; /*0x40 begining address for the 2nd row*/
				break;
		case 2:
				Address=col+0x10; /*0x10 begining address for the 3rd row*/
				break;
		case 3:
				Address=col+0x50; /*0x50 begining address for the 4th row*/
				break;
	}					
